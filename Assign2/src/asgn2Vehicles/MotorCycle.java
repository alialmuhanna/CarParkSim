...
/**
 * The MotorCycle class is a 'specialisation' of the Vehicle class to cater for
 * motorcycles This version uses only those facilities specified in the Vehicle
 * class
 * 
 * @author hogan
 * 
