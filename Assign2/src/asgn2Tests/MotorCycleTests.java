...
public class MotorCycleTests {
	...
	public void testMotorCycleConstructor_InvalidArrivalTime() throws VehicleException {
	...
	/**
	 * Test exiting a parked MotorCycle where departure time is less than parking
	 * time.
	 * @throws VehicleException 
	 */
	@Test(expected=VehicleException.class)
	...
	public void testToString() throws VehicleException {
		...
		assertTrue(motorCycle.toString().contains(String.valueOf(VALID_ARRIVAL_TIME)));
		assertTrue(motorCycle.toString().contains(String.valueOf(VALID_EXIT_TIME)));
		assertTrue(motorCycle.toString().contains(String.valueOf(VALID_EXIT_TIME-VALID_ARRIVAL_TIME)));
		assertTrue(motorCycle.toString().contains(String.valueOf(VALID_PARKING_TIME)));
		assertTrue(motorCycle.toString().contains(String.valueOf(ACTUAL_DEPARTURE_TIME)));
	}
